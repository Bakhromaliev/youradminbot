...
from database.models import User, OutputChannel, SourceChannelLink
...
async def list_channels(message: types.Message, state: FSMContext):
    ...
    await message.answer(get_text('channels_title', lang), reply_markup=builder.as_markup(resize_keyboard=True))
